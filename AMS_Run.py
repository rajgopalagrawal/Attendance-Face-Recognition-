    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:\AttendanceUsingFace\Attendance\ManuallyAttendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\AttendanceUsingFace\Attendance\ManuallyAttendance"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:\AttendanceUsingFace\Attendance' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\AttendanceUsingFace\Attendance"')
    ...
    def log_in():
        ...
        if username == 'Raj':
            if password == 'raj123':
                ...
                cs = 'D:\AttendanceUsingFace\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
